...
require (
	...
	github.com/roadrunner-server/boltdb/v2 v2.14.2
	github.com/roadrunner-server/broadcast/v2 v2.12.2
	github.com/roadrunner-server/cache/v2 v2.13.2
	github.com/roadrunner-server/config/v2 v2.13.4
	github.com/roadrunner-server/endure v1.3.0
	github.com/roadrunner-server/errors v1.1.2
	github.com/roadrunner-server/fileserver/v2 v2.12.4
	github.com/roadrunner-server/goridge/v3 v3.4.1
	github.com/roadrunner-server/grpc/v2 v2.13.4
	github.com/roadrunner-server/gzip/v2 v2.11.3
	github.com/roadrunner-server/headers/v2 v2.11.3
	github.com/roadrunner-server/http/v2 v2.15.8
	github.com/roadrunner-server/informer/v2 v2.11.4
	github.com/roadrunner-server/jobs/v2 v2.13.2
	github.com/roadrunner-server/kv/v2 v2.12.2
	github.com/roadrunner-server/logger/v2 v2.12.4
	github.com/roadrunner-server/memcached/v2 v2.12.2
	github.com/roadrunner-server/memory/v2 v2.13.2
	github.com/roadrunner-server/metrics/v2 v2.12.4
	github.com/roadrunner-server/nats/v2 v2.13.2
	github.com/roadrunner-server/new_relic/v2 v2.13.4
	github.com/roadrunner-server/otel/v2 v2.1.2
	github.com/roadrunner-server/prometheus/v2 v2.12.4
	github.com/roadrunner-server/proxy_ip_parser/v2 v2.4.0
	github.com/roadrunner-server/redis/v2 v2.14.2
	github.com/roadrunner-server/reload/v2 v2.12.1
	github.com/roadrunner-server/resetter/v2 v2.11.4
	github.com/roadrunner-server/rpc/v2 v2.12.4
	github.com/roadrunner-server/sdk/v2 v2.14.0
	github.com/roadrunner-server/send/v2 v2.11.2
	github.com/roadrunner-server/server/v2 v2.13.4
	github.com/roadrunner-server/service/v2 v2.14.5
	github.com/roadrunner-server/sqs/v2 v2.14.2
	github.com/roadrunner-server/static/v2 v2.12.4
	github.com/roadrunner-server/status/v2 v2.12.2
	github.com/roadrunner-server/tcp/v2 v2.12.4
	github.com/roadrunner-server/websockets/v2 v2.13.2
