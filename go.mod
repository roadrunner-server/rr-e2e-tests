...
require (
	...
	go.buf.build/protocolbuffers/go/roadrunner-server/api v1.3.28
...
require (
	...
	github.com/twmb/franz-go v1.12.0 // indirect
	...
	go.buf.build/grpc/go/roadrunner-server/api v1.4.28 // indirect
